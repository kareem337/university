...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({AuthorNotFoundException.class, CourseNotFoundException.class})
    ...
    @ExceptionHandler({InvalidDataException.class, InvalidPaginationException.class})
